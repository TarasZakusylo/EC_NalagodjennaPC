...
public class EC_Rezultatu extends JFrame {
	...
	public EC_Rezultatu(int i_antuvirus, int i_zalizo, int i_Internet, int i_sl_putanna12, int i_sl_putanna13,
			int i_sl_putanna14, int i_sl_putanna15) {
		...
		if (i_ruzuk >= 50 && i_oderejnist < 50) {
			s_Zdatni = "   Ви здатні приймати рішення і діяти при " + "дефіциті інформації та ресурсів. Тобто "
					+ "у Вашій поведінці присутні елементи, які " + "називають авантюрними.";
		}
		if (i_ruzuk >= 50 && i_oderejnist > 50) {
			s_Zdatni = "   Ви раціоналіст. У Вашій поведінці поєднуються "
					+ "віра в свої сили з розумінням того, що не все залежить " + "від Ваших зусиль та настіййливості.";
		}
		if (i_ruzuk <= 50 && i_oderejnist > 50) {
			s_Zdatni = "   Ви належете до групи фаталістів, тобто " + "більше вірите у зовнішні сили, випадкові "
		...
		if (i_ruzuk == 50 && i_oderejnist == 50) {
			s_Zdatni = "   Ви неймовірно унікальна людина. " + "Або не було змінено жодного параметра у опитуванні.";
		}
		if (i_dovira <= 50) {
			s_Zdatni = s_Zdatni + "\n\n   У Вас низький рівень довіри. " + "Вас не рекомендовано займатись бізнесом.";
		} else {
			s_Zdatni = s_Zdatni + "\n\n   У Вас чудовий рівень довіри. " + "Бізнес створено саме для Вас.";
		}
		...
		if (d_Ruzuk < 30) {
			s_Ruzuk = "   Ваша підприємницька угода має дуже " + "високий рівнень надійності і вже врахувала "
					+ "всі можливі витрати. Ви можете бути " + "впевненими в успіху виконання угоди, "
					+ "хоча імтовірність отримання величезного " + "прибутку від реалізації досить мала.";
		}
		if (d_Ruzuk >= 30 && d_Ruzuk <= 70) {
			s_Ruzuk = "   Ризик описаної Вами ситуації є обгрунтованим і на нього варто іти.";
		}
		if (d_Ruzuk > 70) {
			s_Ruzuk = "   Ваша угода є дуже ризикованою. " + "На таку угоду, звісно, також іти можна, "
					+ "але ви повинні бути готовим до можливих " + "великих незапланованих втрат.";
		}
